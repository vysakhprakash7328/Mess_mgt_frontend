...
const Stdntcnctmsg = () => {
  ...
  console.log(phoneNumber,message,fullname,admnNo,email);
  ...
  useEffect(() => {
    ...
    document
      .querySelector(".stdntcnctmsg-input3")
        ...
        <div className="stdntconnect-contents2">
          <div className="connect-navigation2">
            <ul className="connect-sidebar2">
              <li>
                <NavLink
                  to="/checkinnstudenthome"
                  className={"active1-111"}
                  exact
