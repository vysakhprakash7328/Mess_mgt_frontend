...
const Stdntqueries = () => {
  ...
  console.log(phoneNumber,admnNo,email,message,fullname,selectedOption,selectedFile);
  ...
  useEffect(() => {
    ...
    document
      .querySelector(".stdntqueries-input3")
  ...
  return (
    <div className="stdntqueries-group2">
      ...
      <div className="queries-container2">
        ...
        <span className="complainttype">Complaint type:</span>
        <br></br>
        <select
          id="complainttype"
          name="complainttype"
        ...
        >
          ...
          <option value="administrative-management">
        ...
        <span className="complaintfile1">
          Upload complaint files / images (if any):
        </span>
        <input
          type="file"
          id="complaintfile"
